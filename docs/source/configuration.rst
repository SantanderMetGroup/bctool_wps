...
See the bctool_wps help which options are available::

    $ bctool_wps start --help
    --hostname HOSTNAME        hostname in PyWPS configuration.
    --port PORT                port in PyWPS configuration.

Start service with different hostname and port::

    $ bctool_wps start --hostname localhost --port 5001
...
.. code-block:: console
   ...
   $ bctool_wps start -c etc/custom.cfg
